...
![GitHub repo size](https://img.shields.io/github/repo-size/SujalPyDev/data-analytics-sql-portfolio)
...
2. What skills are required for top-paying analyst jobs?
...
- join multiple tables to uncover insights
- analyze salary and skill trends
- present findings in a clean and professional way
- structure a portfolio project for GitHub

## How to Use

1. Open any query from `practice_project_sql/`.
2. Run it against the target jobs dataset in your SQL environment.
3. Save charts or screenshots in `assets/` for portfolio presentation.

## Future Improvements

- Add more visualizations in the `assets/` folder.
- Expand the analysis with new job-market questions.
- Improve query performance and documentation.
- Add more detailed commentary for each SQL file.
